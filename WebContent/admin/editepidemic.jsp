...
<script src="admin/js/editepidemic.js"></script>
				...
				<form name="epidemicForm" method="post">
					...
					<div class="form_content" style="padding-top:4%; padding-bottom: 5%;">
						<div class="form_content">
							<div style="float:left; width:50%;">
								...
								<div style="float:right; width:70%;">
									<input style="width:80%; background:#E6E6E6; " type="text" id="epidemiccode" placeholder="EpidemicCode" name="txtepidemiccode" readonly="readonly"/>
								</div>
							</div>
						...
						<div style="margin: 5% 2% 8% 39%;">
							...
							<div class="btn" style="float:left;" onclick="deleteEpidemic()">Delete</div>
						</div>
						</div>
					</div>
				</form>
