...
<link rel="stylesheet" type="text/css" href="admin/css/addepidemic.css">
<link rel="stylesheet" type="text/css" href="admin/css/main.css">
<link rel="stylesheet" type="text/css" href="admin/css/form.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js"></script>
<script src="admin/js/addepidemic.js"></script>
...
<div class="container">
		...
		<div class="backbody" id="container">
			<div class="body">
				<form name="epidemicForm" method="post" action="addepidemic">
					<div class="form_content" style="border: solid;">
						<center>
							<h1>Epidemics</h1>
						</center>
						<div class="area">
							<table id="epidemictbl" Style="width:100%;">
								<tr class="thead" id="thead">
									<th id="thead">EpidemicCode</th>
									<th id="thead">EpidemicName</th>
									<th id="thead">Description</th>
								</tr>
							</table>
						</div>
					</div>
					<input type="hidden" id="epidemics" name="txtepidemics"/>
					<div class="form_content">
					<div class="form_content" style="padding-top:4%; padding-bottom: 5%;">
						<div class="form_content">
							<div style="float:left; width:50%;">
								<div style="float:left; width:30%;">
									<label style="float:left; margin-right: 5%;">EpidemicCode</label>
								</div>
								<div style="float:right; width:70%;">
									<input style="width:80%; background:#E6E6E6; " type="text" id="epidemiccode" placeholder="EpidemicCode" name="txtepidemiccode"
									value="<%
										Main m = new Main();
										String id = m.generateCode("epidemic","ep");
										if(id!=null){
											out.println(id);
										}
									%>" readonly="readonly"/>
							...
							<div style="float:right; width:50%;">
								<div style="float:left; width:30%;">
									<label style="float:left; margin-right: 5%;">EpidemicName</label>
								</div>
								<div style="float:left; width:70%;">
									<input style="width:80%;" type="text" id="epidemicname" placeholder="EpidemicName" name="txtepidemicname">
								</div>
							</div>
						...
						<div style="margin: 5% 2% 8% 39%;">
							<div class="btn" style="float:left;" onclick="addEpidemicToAdd()">Add</div>
							<div class="btn" style="float:left;" onclick="removefromTable(epidemictoaddtbl)">Remove</div>
						</div>
						<div class="area">
							<table id="epidemictoaddtbl" Style="width:100%;">
								<tr class="thead" id="thead">
									<th id="thead">EpidemicCode</th>
									<th id="thead">EpidemicName</th>
									<th id="thead">Description</th>
