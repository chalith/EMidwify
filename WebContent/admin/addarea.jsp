...
<link rel="stylesheet" type="text/css" href="admin/css/addarea.css">
<link rel="stylesheet" type="text/css" href="admin/css/main.css">
<link rel="stylesheet" type="text/css" href="admin/css/form.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js"></script>
<script src="admin/js/addarea.js"></script>
		...
		<div class="backbody" id="container">
			<div class="body">
				<form name="areaForm" method="post">
					...
					<input type="hidden" id="areas" name="txtareas"/>
						...
						<div class="form_content">
							<div style="float:left; width:50%;">
								...
								<div style="float:right; width:70%;">
									<input style="width:80%; background:#E6E6E6; " type="text" id="areacode" placeholder="AreaCode" name="txtareacode"
									value="<%
										Main m = new Main();
										String id = m.generateCode("area","A");
										if(id!=null){
											out.println(id);
										}
									%>" readonly="readonly"/>
