...
<script src="admin/js/editadmininfo.js"></script>
...
<div class="container">
	...
	<div class="backbody" id="container" >
		<div class="body">
			<form action="admineditinfo" method="post" name="admineditForm">
				...
				<div class="form_content" style="border:solid; padding-top:4%; padding-bottom: 5%;">
					...
					<div style="float:left; width:45%;">
						<div style="float:left; width:40%;">
							<label>Admin NIC/ID</label>
						</div>
						<div style="float:left; width:60%;">
							<input style="width:60%; background:#E6E6E6;" placeholder="AdminID" type="text" id="adminid" name="txtadminid" value = 
								"<%	
									out.print(id);
								%>" 
							readonly/>
