...
@WebServlet("/midwifeeditinfo")
public class MidwifeEditInfo extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/midwife/editmidwifeinfo.jsp").forward(request,response);
	}
}
