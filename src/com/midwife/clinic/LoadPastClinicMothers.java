...
@WebServlet("/loadpastclinicmothers")
public class LoadPastClinicMothers extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MotherInClinic> mothers = clinic.getUnvisitedMothers();
		int unvisitedcount = clinic.getUnvisitedMotherCount();
