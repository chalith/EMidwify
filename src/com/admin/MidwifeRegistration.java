...
@WebServlet("/midwiferegistration")
public class MidwifeRegistration extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
        	...
        	getServletContext().getRequestDispatcher("/admin/midwiferegistration.jsp").forward(request,response);
        }finally{
 			try {
				jdbc.conn.close();
